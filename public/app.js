...
window.CNC_APP={
  toast,
  getSyncPayload(){return {version:'3.0.4',machine:store.get(KEYS.machine,state.machine),tools:store.get(KEYS.tools,[]),projects:store.get(KEYS.projects,[]),draft:store.get(KEYS.draft,null),syncMarks:store.get(KEYS.syncMarks,{tools:{},projects:{}}),updatedAt:new Date().toISOString()}},
